...
@section('content')
<div ng-app="AppSell" ng-controller="CtrlSell">
	<form class="form-horizontal" name="SellForm" novalidate  method="post" action="{{ URL::route('sell') }}">
			...
			<div class="form-group" >
			    <label class="control-label col-sm-3">{{ Lang::get('ccp.paypal_account') }}: </label>
			    <div>
			        <input type="email" name="paypal"  {{ Input::old('paypal')? "value='".Input::old('paypal')."'":""  }} >
			    </div>
			...
			<div class="form-group" >
			    <label class="control-label col-sm-3">{{ Lang::get('ccp.paypal_first_name') }}: </label>
			    <div>
			        <input type="text" name="paypal_first_name"  {{ Input::old('paypal_first_name')? "value='".Input::old('paypal_first_name')."'":""  }} >
			    </div>
			...
			<div class="form-group" >
			    <label class="control-label col-sm-3">{{ Lang::get('ccp.paypal_last_name') }}: </label>
			    <div>
			        <input type="text" name="paypal_last_name"  {{ Input::old('paypal_last_name')? "value='".Input::old('paypal_last_name')."'":""  }}>
			    </div>
